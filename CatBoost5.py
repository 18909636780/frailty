...
feature_names = ["age", "MCC", "HGB", "NLR", "TC","cognitive_state","vegetable","medicine","education"]
...
# 准备输入特征
feature_values = [age, MCC,HGB,NLR,TC,cognitive_state, vegetable,medicine,education]
